...
import ro.upt.sma.context.activity.ActivityRecognitionService.Companion.ACTIVITY_EXTRA
        ...
        when (requestCode) {
            PERMISSION_REQUEST_ID -> {
                if (grantResults.isNotEmpty() && grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(this, R.string.toast_location_permission, Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
